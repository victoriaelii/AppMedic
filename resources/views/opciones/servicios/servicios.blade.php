                ...
                <div class="p-6 text-gray-900">
                    <div class="overflow-x-auto">
                        ...
                        <form method="GET" action="{{ route('servicios') }}" class="flex mb-4 space-x-4">
                            ...
                            <input type="number" name="precio" placeholder="Precio del Servicio" class="border border-gray-300 p-2 rounded-md" value="{{ request('precio') }}" min="0" step="0.01">
                                ...
                                @foreach($servicios as $servicio)
                                    <tr class="hover:bg-gray-100 transition" style="background-color: rgba(255, 255, 255, 0.6);">
                                        ...
                                        <td class="px-6 py-4 text-center flex items-center justify-center space-x-2">
                                            ...
                                            <a href="{{ route('servicios.editar', $servicio->id) }}" class="text-yellow-600 hover:text-yellow-900 transition">
