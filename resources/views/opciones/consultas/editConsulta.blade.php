                                    ...
                                    @foreach($receteItems as $item)
                                        @if(is_array($item))
                                            <div class="grid grid-cols-5 gap-4 receta-item">
                                                <input type="text" name="medicacion[]" placeholder="Medicación" value="{{ old('medicacion[]', $item['medicacion']) }}" class="col-span-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                                                <input type="number" name="cantidad[]" placeholder="Cantidad" value="{{ old('cantidad[]', $item['cantidad']) }}" class="col-span-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                                                <input type="text" name="frecuencia[]" placeholder="Frecuencia" value="{{ old('frecuencia[]', $item['frecuencia']) }}" class="col-span-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
                                                <input type="text" name="duracion[]" placeholder="Duración" value="{{ old('duracion[]', $item['duracion']) }}" class="col-span-1 px-4 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" />
    ...
    <script>
        ...
        function toggleCantidad(checkbox) {
            ...
            if (checkbox.checked) {
                ...
                cantidadInput.value = '';  // reset value
            } else {
