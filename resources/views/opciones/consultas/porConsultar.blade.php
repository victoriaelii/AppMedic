                    ...
                    <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full text-center text-sm bg-white border-collapse" style="background-color: rgba(255, 255, 255, 0.6); backdrop-filter: blur(5px);">
                            <thead class="bg-gray-50 border-b text-center" style="background-color: rgba(255, 255, 255, 0.6); border-bottom: 2px solid rgba(0, 0, 0, 0.1);">
                                <tr>
                                    <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-lg">Fecha</th>
                                    <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-lg">Hora</th>
                                    <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-lg">Paciente</th>
                                    <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-lg">Total a Pagar</th>
                                    <th scope="col" class="px-6 py-4 font-semibold text-gray-700 text-lg">Acción</th>
                                </tr>
                            </thead>
                                            ...
                                            <tr class="hover:bg-gray-100 transition" style="background-color: rgba(255, 255, 255, 0.6);">
                                                ...
                                                <td class="px-6 py-4 flex items-center justify-center space-x-2">
                                                    <a href="{{ route('consultas.edit', $cita->consulta->id) }}">
                                                        <button class="text-blue-500 px-4 py-2 rounded-md hover:bg-blue-200 transition">
